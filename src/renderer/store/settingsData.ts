...
export type TSettingTypes = ISettingKeybind | ISettingInteger | ISettingCheckbox | ISettingEnum
  ...
  switch (settingInfo.type) {
    ...
    case 'enum':
      ...
      return acceptedIds.includes(settingValue)
        ? {valid: true}
        : {valid: false, errorMessage: `The value '${settingValue}' is not an accepted value`}
    default:
      return {valid: true}
  }
}
