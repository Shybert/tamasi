<template>
  <div class="inputKeybind">
    ...
    <button type="button" :class="{active: isRecording}" @keydown.prevent="keypressService.keydown" @keyup.prevent="keypressService.keyup" @click.prevent="switchRecordingKeybindInput" @blur="stopRecordingKeybindInput">Edit keybind</button>    
  </div>
</template>
